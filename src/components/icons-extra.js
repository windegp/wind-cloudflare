...
export const Verified = (props) => <IconWrapper {...props} fill="none"><circle cx="12" cy="12" r="10" fill="#1877F2" stroke="none"/><polyline points="8 12 11 15 16 9" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/></IconWrapper>;
