...
export const Verified = (props) => (
  <IconWrapper {...props} fill="none">
    <path 
      d="M12 1.5l1.8 2.2 2.8-.6.8 2.7 2.9.4-.2 2.9 2.5 1.4-1.1 2.7 1.7 2.3-1.9 1.9.9 2.8-2.6.8-.3 2.9-2.9-.3-1.4 2.5-2.7-1.1-2.3 1.7-1.9-1.9-.8 2.6-2.9-.3-.4 2.9-2.9.2-.8-2.8-2.7 1.1-1.4-2.5-2.9.3-.3-2.9-2.6-.8.9-2.8-1.9-1.9 1.7-2.3-1.1-2.7 2.5-1.4-.2-2.9 2.9-.4.8-2.7 2.8.6z" 
      fill="#1877F2" 
      stroke="none"
    />
    <polyline 
