...
export const Verified = (props) => (
  <IconWrapper {...props} fill="none">
    <path
      d="M22.5 12.5c0 .5-.2 1-.5 1.3.4.4.5.9.4 1.4-.1.5-.4.9-.8 1.2.2.5.2 1-.1 1.4-.3.4-.7.7-1.2.8.1.5 0 1-.3 1.4-.3.4-.8.6-1.3.6 0 .5-.2 1-.6 1.3-.4.3-.9.4-1.4.3-.2.5-.5.9-1 1.1-.4.2-1 .2-1.4 0-.4.4-.9.6-1.4.6s-1-.2-1.4-.6c-.4.2-.9.2-1.4 0-.5-.2-.8-.6-1-1.1-.5.1-1 0-1.4-.3-.4-.3-.6-.8-.6-1.3-.5 0-1-.2-1.3-.6-.3-.4-.4-.9-.3-1.4-.5-.1-.9-.4-1.2-.8-.3-.4-.3-.9-.1-1.4-.4-.3-.7-.7-.8-1.2-.1-.5 0-1 .4-1.4-.3-.3-.5-.8-.5-1.3 0-.5.2-1 .5-1.3-.4-.4-.5-.9-.4-1.4.1-.5.4-.9.8-1.2-.2-.5-.2-1 .1-1.4.3-.4.7-.7 1.2-.8-.1-.5 0-1 .3-1.4.3-.4.8-.6 1.3-.6 0-.5.2-1 .6-1.3.4-.3.9-.4 1.4-.3.2-.5.5-.9 1-1.1.4-.2 1-.2 1.4 0 .4-.4.9-.6 1.4-.6s1 .2 1.4.6c.4-.2.9-.2 1.4 0 .5.2.8.6 1 1.1.5-.1 1 0 1.4.3.4.3.6.8.6 1.3.5 0 1 .2 1.3.6.3.4.4.9.3 1.4.5.1.9.4 1.2.8.3.4.3.9.1 1.4.4.3.7.7.8 1.2.1.5 0 1-.4 1.4.3.3.5.8.5 1.3z"
      fill="#1877F2"
      stroke="none"
    />
    <path
